...
defmodule Aura.Model.HexRelease do
  ...
  @typedoc Aura.Doc.type_doc("Type describing a `Aura.Model.HexRelease`",
             keys: %{
               checksum: {HexRelease, :release_checksum},
               configs: {HexRelease, :build_tool_declarations},
               docs_html_url: Common,
               has_docs: {HexRelease, :docs?},
               meta: {HexRelease, :release_meta},
               publisher: {HexRelease, :release_publisher},
               html_url: Common,
               downloads: {HexRelease, :release_downloads},
               inserted_at: Common,
               retirement: {HexRelease, :retired?},
               package_url: {HexRelease, :package_reference_url},
               requirements: {HexRelease, :release_requirement, :list},
               updated_at: Common,
               url: Common,
